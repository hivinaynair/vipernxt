...
Hosted orchestration now uses [Eve durable workflows](../../deploy/eve/README.md) on Vercel. The earlier single-host controller has been removed. Cursor API credentials remain separate from MCP integrations; parallel scheduling is not implemented.
