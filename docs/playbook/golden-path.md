...
1. `/next` → site, what they use today, drop the pile. Record `engagement.site`. An idea is a **claim**, optional.
...
Do not: deep-research before the incumbent check; start from an idea paragraph; copy the incumbent's menu; dump eight questions; invent a second homework generator; run `setup.sh` before they accept the clip; mark shape done without U5; write the dry-run into this repo.
