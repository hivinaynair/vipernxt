...
1. `/next` → **somebody who told you they have the problem**, what they use today, pile (`docs/research/salvage-inbox/`; cloud: transcripts or one zip). Record `engagement.site` — no name, nothing past the category scan opens. An idea is a **claim**, optional.
